...
namespace alpaka::trait
{
    ...
    template<typename TDev, bool TBlocking>
    struct DevType<QueueGenericSyclBase<TDev, TBlocking>>
    {
        using type = TDev;
    };
    ...
    template<typename TDev, bool TBlocking>
    struct GetDev<QueueGenericSyclBase<TDev, TBlocking>>
    {
        static auto getDev(QueueGenericSyclBase<TDev, TBlocking> const& queue)
        {
    ...
    template<typename TDev, bool TBlocking>
    struct EventType<QueueGenericSyclBase<TDev, TBlocking>>
    {
    ...
    struct Enqueue<QueueGenericSyclBase<TDev, TBlocking>, TTask>
    {
        static auto enqueue(QueueGenericSyclBase<TDev, TBlocking>& queue, TTask const& task) -> void
        {
            ALPAKA_DEBUG_MINIMAL_LOG_SCOPE;
    ...
    template<typename TDev, bool TBlocking>
    struct Empty<QueueGenericSyclBase<TDev, TBlocking>>
    {
        static auto empty(QueueGenericSyclBase<TDev, TBlocking> const& queue) -> bool
        {
            ALPAKA_DEBUG_MINIMAL_LOG_SCOPE;
    ...
    template<typename TDev, bool TBlocking>
    struct CurrentThreadWaitFor<QueueGenericSyclBase<TDev, TBlocking>>
    {
        static auto currentThreadWaitFor(QueueGenericSyclBase<TDev, TBlocking> const& queue) -> void
        {
            ALPAKA_DEBUG_MINIMAL_LOG_SCOPE;
            queue.m_impl->wait();
        }
    ...
    template<typename TDev, bool TBlocking>
    struct NativeHandle<QueueGenericSyclBase<TDev, TBlocking>>
    {
        [[nodiscard]] static auto getNativeHandle(QueueGenericSyclBase<TDev, TBlocking> const& queue)
        {
