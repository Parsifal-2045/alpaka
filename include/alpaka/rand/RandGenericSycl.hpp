...
#    if !defined(ALPAKA_HOST_ONLY)
    ...
    namespace distribution::trait
    {
        ...
        template<typename TRand, typename T>
        struct CreateNormalReal<RandGenericSycl, T, std::enable_if_t<std::is_floating_point_v<T>>>
        {
            static auto createNormalReal(RandGenericSycl const& /*rand*/)
                -> sycl_rand::NormalReal<T>
            {
                return {};
            }
        };
        ...
        {
            static auto createUniformReal(RandGenericSycl const& /*rand*/)
                -> sycl_rand::UniformReal<T>
            {
                return {};
            }
        };
        ...
        {
            static auto createUniformUint(RandGenericSycl const& /*rand*/)
                -> sycl_rand::UniformUint<T>
            {
                return {};
            }
        };
